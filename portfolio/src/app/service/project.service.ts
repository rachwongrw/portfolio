...
export class ProjectService {
  projects: Project[] = [
    ...
    new Project(4, 'Group Project In Angular', "Angular, Node, JS", 'This was originally a school group project where we created an snowboarding ecommerce website. This was converted from Vanilla JS to Angular.', "../../assets/images/suki.png"),
